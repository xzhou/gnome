...
% fastafile = 'chr10_FGFR2_200kb_phased_yri.fasta';DrTest(fastafile, 0.5)
% DrTest(fastafile, 0.2)
% DrTest(fastafile, 0.1)
% DrTest(fastafile, 0.01)
% DrTest(fastafile, 0.001)

% a(1:5,1)=DrTest(fastafile, [], -log10(0.5))
% a(1:5,2)=DrTest(fastafile, [], -log10(0.2))
% a(1:5,3)=DrTest(fastafile, [], -log10(0.1))
% a(1:5,4)=DrTest(fastafile, [], -log10(0.01))
% a(1:5,5)=DrTest(fastafile, [], -log10(0.001))
