function [StatS, StatR, StatT, Truth] = newDrTest()
...
withmissingSNP = 0; % decided the missing SNPs
...
Ref_haplotypeFile = 'SIM_100x77_ctl.fasta';

% Test_haplotypeFile = 'hapmap_chr7_80SNP_CEU_haplotype_83_164.fasta';
% Out_haplotypeFile = 'hapmap_chr7_80SNP_YRI_haplotype.fasta';

Test_haplotypeFile = '80SNP_CEU_sim_4000seq_sample1000.fasta';
Out_haplotypeFile = '80SNP_CEU_sim_4000seq_control1000.fasta';
